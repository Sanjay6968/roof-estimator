  ...
  try {
    ...
    if (configCount === 0) {
      const seedConfig = {
        ...
        questions: [
          { key: "roof_area", label: "Roughly how big is your roof?", type: "number", unit: "sq ft", required: true, min: 300, max: 12000, active: true },
          { key: "material", label: "What material do you want?", type: "select", required: true, active: true, options: [
          ...
          { key: "stories", label: "How many stories is the house?", type: "select", required: true, active: true, options: [
